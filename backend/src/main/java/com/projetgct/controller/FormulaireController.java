...
public class FormulaireController {
	...
	public ResponseEntity<Formulaire> updateFormulaire(@PathVariable("id") Long id,
			@RequestBody Formulaire updatedFormulaire) {
		...
		if (existingFormulaireOptional.isPresent()) {
			...
			existingFormulaire
					.setConditionsParticipationestVisible(updatedFormulaire.isConditionsParticipationestVisible());
